...
const [showAllPhotos, setShowAllPhotos] =useState(false)
  ...
  return (
    <div className="grid grid-cols-4 grid-rows-3 gap-2 p-4 md:gap-4 md:p-6 lg:gap-6 lg:p-8 mt-6 mb-6">
      ...
      <button onClick={(setShowAllPhotos) => ((currentState) => !currentState) }className='"text-yellow-500 mb-5 hover:text-red-100'>
  {showAllPhotos ? "less" : "more"}
      </button>
    </div>
  );
};
